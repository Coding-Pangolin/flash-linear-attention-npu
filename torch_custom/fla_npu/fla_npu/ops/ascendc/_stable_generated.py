...
_GENERATED_HASH = "cf71d2380c86cbffb2fe2b12abe1ffde"

_SIG = {
    "npu_causal_conv1d": [("x", "tensor"), ("weight", "tensor"), ("bias", "optional_tensor"), ("conv_states", "optional_tensor"), ("query_start_loc", "int_array"), ("cache_indices", "int_array"), ("initial_state_mode", "int_array"), ("num_accepted_tokens", "int_array"), ("activation_mode", "int64"), ("pad_slot_id", "int64"), ("run_mode", "int64"), ("head_num", "int64")],
...
def npu_causal_conv1d(x, weight, bias=None, conv_states=None, *, query_start_loc=None, cache_indices=None, initial_state_mode=None, num_accepted_tokens=None, activation_mode=0, pad_slot_id=-1, run_mode=0, head_num=0):
    return _call("npu_causal_conv1d", {
        "x": x,
        "weight": weight,
        "bias": bias,
