"""Load GPU GDN dump .pt files and convert BTH -> NPU BHT layout."""
...
def load_dump_for_npu(path: str | Path) -> tuple[dict[str, Any], dict[str, Any], dict[str, Any]]:
    """Return (inputs_bht, meta, outputs_bht) from a GPU dump .pt file."""
...
def find_op_dump_pt(
    ...
    *,
    ...
    """Locate *_{op_name}.pt under case_dir; prefer meta.phase when multiple exist."""
