 ...
 */
#ifndef CHUNK_GDN_CORE_FWD_ARCH32_STRUCT_H
#define CHUNK_GDN_CORE_FWD_ARCH32_STRUCT_H
...
struct Arch32ChunkGdnCoreFwdAbcTiling {
    uint64_t B;
    uint64_t Hk;
    uint64_t Hv;
    uint64_t hvPerHk;
...
struct Arch32ChunkGdnCoreFwdTrailer {
...
#endif // CHUNK_GDN_CORE_FWD_ARCH32_STRUCT_H
