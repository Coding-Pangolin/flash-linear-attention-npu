...
### 下一刀（借 PR190，见 `PR190_BORROW_ANALYSIS.md` / `ITER_A0_A2_PLAN.md`）

| 优先级 | 项 | 状态 |
|--------|-----|------|
| **A0** | UB：`g`/`beta` chunk resident | **实现保留 · default off**（短块/aicore） |
| A1 | L1 scratch/resident 注释 | done（随 A0） |
| A2 | Score：MMAD1 ‖ 搬 W | pending |
